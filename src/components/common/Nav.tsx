...
const Nav = () => {
  return (
    <>
      <nav className=" max-w-screen-xl mx-auto sm:mx-4 md:mx-8 lg:mx-16 xl:mx-24 bg-Cultured px-4 py-4 flex items-center justify-between border border-b-2 ">
        {/* logo */}
        ...
        <div className=" flex items-center justify-between">
          <ul className=" font-poppins flex items-center justify-between gap-4 mr-4 ">
            ...
            <li className="  cursor-pointer flex items-center">
              Write <BsPencilFill className=" ml-1" />
            </li>
